...
univariate <- function(y, q.range=c(0.05,0.95), w=NULL, bsrep=200, alpha=0.05){
  n <- length(y)
...
#summary
summary.univariate <- function(object, taus=0.05){
  if(length(taus)==1){
...
#plot
plot.univariate <- function(object, xlim=NULL, ylim=NULL, main=NULL, xlab=NULL, ylab=NULL, add=FALSE, col.l="dark blue", col.b="light blue", shift=NULL, lty.l=1, lwd.l=1, lty.b=1, lwd.b=5){
